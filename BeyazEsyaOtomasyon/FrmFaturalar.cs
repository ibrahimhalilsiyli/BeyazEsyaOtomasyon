    ...
    public partial class FrmFaturalar : Form
    {
        ...
        private void BtnKaydet_Click(object sender, EventArgs e)
        {
            ...
            if(TxtFaturaid.Text != "")
            {
                ...
                SqlCommand komutStokDus = new SqlCommand("update TBL_URUNLER set ADET = ADET - @p1 where URUNAD = @p2", bgl.baglanti());
                komutStokDus.Parameters.AddWithValue("@p1", decimal.Parse(TxtMiktar.Text));
                komutStokDus.Parameters.AddWithValue("@p2", TxtUrunAd.Text);
